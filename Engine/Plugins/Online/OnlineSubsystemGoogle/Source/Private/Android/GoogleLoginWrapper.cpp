...
bool FGoogleLoginWrapper::Init(const FString& ServerClientId, bool bRequestIdToken, bool bRequestServerAuthCode)
{
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
	{
		...
		{
			static jmethodID GetGoogleLoginMethod = FJavaWrapper::FindMethod(Env, FJavaWrapper::GameActivityClassID, "getGoogleLogin", "()Lcom/epicgames/ue4/GoogleLogin;", false);
...
JNI_METHOD void Java_com_epicgames_ue4_GoogleLogin_nativeLoginSuccess(JNIEnv* jenv, jobject thiz, jstring InUserId, jstring InGivenName, jstring InFamilyName, jstring InDisplayName, jstring InPhotoUrl, jstring InIdToken, jstring InServerAuthCode)
{
...
JNI_METHOD void Java_com_epicgames_ue4_GoogleLogin_nativeLoginFailed(JNIEnv* jenv, jobject thiz, jint ResponseCode)
{
