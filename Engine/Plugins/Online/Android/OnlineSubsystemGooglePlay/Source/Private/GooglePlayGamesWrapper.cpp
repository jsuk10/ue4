...
void FGooglePlayGamesWrapper::Init()
{
	...
	{
		PlayGamesWrapperClass = FAndroidApplication::FindJavaClassGlobalRef("com/epicgames/ue4/GooglePlayGamesWrapper");
		UE_CLOG_ONLINE(PlayGamesWrapperClass == nullptr, Error, TEXT("Could not find com.epicgames.ue4.GooglePlayGamesWrapper class to interface with Java side"));
	...
	if (PlayGamesWrapperClass != nullptr && WriteAchievementsId != nullptr)
	{
		if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
		{
			...
			for (int32 Idx = 0; Idx < WriteAchievementsData.Num(); ++Idx)
			{
				...
				jstring Id = Env->NewStringUTF((const char*)TCHAR_TO_UTF8(*Entry.GooglePlayAchievementId));
...
JNI_METHOD void Java_com_epicgames_ue4_GooglePlayGamesWrapper_nativeLoginSuccess(JNIEnv* jEnv, jclass /*Clazz*/, jlong TaskPtr, jstring InPlayerId, jstring InPlayerDisplayName, jstring InAuthCode)
{
...
JNI_METHOD void Java_com_epicgames_ue4_GooglePlayGamesWrapper_nativeLoginFailed(JNIEnv* jEnv, jclass /*Clazz*/, jlong TaskPtr)
{
	FOnlineAsyncTaskGooglePlayLogin* Task = reinterpret_cast<FOnlineAsyncTaskGooglePlayLogin*>(TaskPtr);
...
JNI_METHOD void Java_com_epicgames_ue4_GooglePlayGamesWrapper_nativeLeaderboardRequestSuccess(JNIEnv* jEnv, jclass /*Clazz*/, jlong TaskPtr, jstring InDisplayName, jstring InPlayerId, jlong InRank, jlong InRawScore)
{
...
JNI_METHOD void Java_com_epicgames_ue4_GooglePlayGamesWrapper_nativeLeaderboardRequestFailed(JNIEnv* jEnv, jclass /*Clazz*/, jlong TaskPtr)
{
	FOnlineAsyncTaskGooglePlayReadLeaderboard* Task = reinterpret_cast<FOnlineAsyncTaskGooglePlayReadLeaderboard*>(TaskPtr);
...
JNI_METHOD void Java_com_epicgames_ue4_GooglePlayGamesWrapper_nativeFlushLeaderboardsCompleted(JNIEnv* jEnv, jclass /*Clazz*/, jlong TaskPtr, jboolean InSuccess)
{
...
JNI_METHOD void Java_com_epicgames_ue4_GooglePlayGamesWrapper_nativeQueryAchievementsFailed(JNIEnv* jEnv, jclass /*Clazz*/, jlong TaskPtr)
{
	FOnlineAsyncTaskGooglePlayQueryAchievements* Task = reinterpret_cast<FOnlineAsyncTaskGooglePlayQueryAchievements*>(TaskPtr);
...
JNI_METHOD void Java_com_epicgames_ue4_GooglePlayGamesWrapper_nativeWriteAchievementsCompleted(JNIEnv* jEnv, jclass /*Clazz*/, jlong TaskPtr, jobjectArray InSucceeded)
{
