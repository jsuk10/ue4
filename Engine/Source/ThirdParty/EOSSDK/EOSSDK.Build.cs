...
public class EOSSDK : ModuleRules
{
	...
	public virtual string SDKBinariesDir
	{
		get
		{
            ...
            {
				return Path.Combine(SDKBaseDir, "Bin", "Android", "static-stdc++");
            }
	...
	public EOSSDK(ReadOnlyTargetRules Target) : base(Target)
	{
		...
		if (Target.Platform == UnrealTargetPlatform.Android)
		{
			...
			PublicAdditionalLibraries.Add(Path.Combine(SDKBinariesDir, "libs", "x86", RuntimeLibraryFileName));
			PublicAdditionalLibraries.Add(Path.Combine(SDKBinariesDir, "libs", "x86_64", RuntimeLibraryFileName));
