			...
			, Bounds(InModelElement.BoundingBox)
		{
			...
			if (RHISupportsManualVertexFetch(GMaxRHIShaderPlatform))
			{
				...
				ENQUEUE_RENDER_COMMAND(FElementInfoCreateLocalVFUniformBuffer)(
					[UniformBufferPtr, VertexFactoryTmp = InVertexFactory, ElementIndex = InElementIndex](FRHICommandListImmediate& RHICmdList)
				{
					*UniformBufferPtr = CreateLocalVFUniformBuffer(VertexFactoryTmp, ElementIndex, nullptr, 0, 0);
				});
			}
		}
