	...
	bool bShouldRenderSkyAtmosphere, bool bShouldRenderVolumetricCloud)
{
	...
	auto RenderCubeFaces_DiffuseIrradiance = [&](TRefCountPtr<IPooledRenderTarget>& SourceCubemap)
	{
		...
		AddPass(GraphBuilder, [SkyIrradianceEnvironmentMapTmp = SkyIrradianceEnvironmentMap.Buffer, SkyIrradianceEnvironmentMapUAVTmp = SkyIrradianceEnvironmentMap.UAV](FRHIComputeCommandList& RHICmdList)
		{
			RHICmdList.Transition(FRHITransitionInfo(SkyIrradianceEnvironmentMapUAVTmp, ERHIAccess::Unknown, ERHIAccess::UAVCompute));
		});
		...
		AddPass(GraphBuilder, [SkyIrradianceEnvironmentMapTmp = SkyIrradianceEnvironmentMap.Buffer, SkyIrradianceEnvironmentMapUAVTmp = SkyIrradianceEnvironmentMap.UAV](FRHICommandList& RHICmdList)
		{
			RHICmdList.Transition(FRHITransitionInfo(SkyIrradianceEnvironmentMapUAVTmp, ERHIAccess::UAVCompute, ERHIAccess::SRVMask));
		});
	};
